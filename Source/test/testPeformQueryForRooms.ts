...
// ==============  tests start here =====================
    ...
    it(" simple query", function() {
        ...
        return insight.addDataset(id, file).then((response) => {
            ...
            return insight.performQuery(query).then((isresponse:any) => {
                //console.log(5);
                checkResults([{ "rooms_name": "DMP_101" }, { "rooms_name": "DMP_110" }, { "rooms_name": "DMP_201" }, { "rooms_name": "DMP_301" }, { "rooms_name": "DMP_310" }],
    ...
    it(" simple query OR AND should fail", function() {
        ...
        return insight.addDataset(id, file).then((response) => {
            //let fa= [""]
            //console.log("ASDFJASLKDFJSDGSL   " +  fa[0])
            let query = {
                "WHERE": {
                    "OR":[""]
                },
    ...
    it(" simple query-debugging2", function() {
        ...
        return insight.addDataset(id, file).then((response) => {
            ...
            return insight.performQuery(query).then((isresponse:any) => {
                //console.log(5);
                checkResults([{"rooms_name":"WESB_100"},{"rooms_name":"WESB_201"}],
                    isresponse.body["result"])
                //console.log("----------------------")
            }).catch((iserr) => {
                //console.log("+++++++++++++++++++")
    ...
    it(" simple queryx", function() {
        ...
        return insight.addDataset(id, file).then((response) => {
            ...
            return insight.performQuery(query).then((isresponse:any) => {
                //console.log(5);
                checkResults([{"rooms_lat":49.26125,"rooms_lon":-123.24807},{"rooms_lat":49.26125,"rooms_lon":-123.24807},{"rooms_lat":49.26125,"rooms_lon":-123.24807},{"rooms_lat":49.26125,"rooms_lon":-123.24807},{"rooms_lat":49.26125,"rooms_lon":-123.24807}],
                    isresponse.body["result"])
                //console.log("----------------------")
            }).catch((iserr) => {
                //console.log("+++++++++++++++++++")
